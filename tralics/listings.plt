...
\define@key{lst}{stringstyle}{\XMLaddatt{stringstyle}{#1}}
\define@key{lst}{captionpos}{\XMLaddatt{captionpos}{#1}}
\define@key{lst}{aboveskip}{\XMLaddatt{aboveskip}{#1}}
\define@key{lst}{commentstyle}{\XMLaddatt{commentstyle}{#1}}
\define@key{lst}{showstringspaces}{\XMLaddatt{showstringspaces}{#1}}
